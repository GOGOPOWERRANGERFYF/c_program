...
void main(void)
{
    ...
    //            0.4 * 2 = 0.8 --> 0
    //
    // 0.1(binary): 0.0001 1001 1001 1001 1001 100|1100 * (2^0)10
    //              0.0001 1001 1001 1001 1001 101(rounding) * (2^0)10
    //      规格化: 0 0001.10011001100110011001100| * (2^-4)10       
    //        -->       1.10011001100110011001100 * (2^-4)10
    //                  
    printf("f1(d):%d\n",f1);
    printf("sizeof(f1):%d\n", sizeof(f1));
