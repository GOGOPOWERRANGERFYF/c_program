...
//
//  二进制表示: value(binary)   = 0.0000 0000 0000 0000 001 * 10^(1-0111 1111)
//                             = 0.0000 0000 0000 0000 001 * 10^(-0111 1110)
//  十进制表示: value(decimal)  = 1/2^23 * 2^(-126)
//                             = 2^(-23) * 2^(-126)
//                             = 2^(-149)
//  M(隐含0.)=f=1*(2^-23) 这里的位权(2^-23)用十进制表示    备注:直接用二进制表示: 1*(10^-10111)
//         E=1-(2^8-1 -1)= -126   这里也是用十进制表示
//
//  最小非规格化数(十进制表示) = M * 2^E = 2^-23 * 2^-126 = 2^-149 ≈ 1.4 * 10^-45  
//
//-----------------------------------------------------------------------------------
// 6.75(10) >> 110.11(2)
