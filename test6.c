...
//  二进制表示: value(binary)   = 0.0000 0000 0000 0000 001 * 10^(1-0111 1111)   excess_127=bias=127(decimal)=0111 1111(binary)
...
int main(void)
{
    ...
    //*重要知识点:C99标准添加的十六进制浮点数常量格式: 
    // 1.ap10  mantisa:(1.a)16; p10=2^10  
