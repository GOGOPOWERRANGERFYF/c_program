...
//     sign[S]   exponent[E]    mantissa[M]       [S]   decimal[E] fraction                 
//   非规格数---------------------------------           e   E=(1-b)  2^E
//       0           000         00   (0+f)        +    0   -2       1/4  
//       0           000         01   (0+f)        +    0   -2       1/4
//       0           000         10   (0+f)        +    0   -2       1/4
//       0           000         11   (0+f)        +    0   -2       1/4
//   规格数-----------------------------------
//       0           001         00   (1+f)        +    1   -2       1/4
//       0           001         01   (1+f)        +    1   -2       1/4
//       0           001         10   (1+f)        +    1   -2       1/4
//       0           001         11   (1+f)        +    1   -2       1/4
//
//       0           010         00   (1+f)        +    2   -1       1/2 
//       0           010         01   (1+f)        +    2   -1       1/2 
//       0           010         10   (1+f)        +    2   -1       1/2 
//       0           010         11   (1+f)        +    2   -1       1/2 
//
//       0           011         00   (1+f)        +    3    0        1
//       0           011         01   (1+f)        +    3    0        1
//       0           011         10   (1+f)        +    3    0        1
