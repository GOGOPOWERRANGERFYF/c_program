...
//  w=3   s=x+y=[0,2^w+1 -2]   s=x +u/w y=x+y-2^w
//            1(110) -------
//            1(101)       |
//            1(100)       |
//            1(011)     map3
...
//  2^w等于w个2相乘,2*2^(w-1)=2^1 * 2^(w-1) 就是w-1个2相乘,再乘个2不就是w-1+1=w个2相乘,
//                          =2^1+w-1 = 2^w
//  2^w/2^1就是w个2相乘,除于2,不就还剩w-1个2相乘
//  =2^(w-1)
...
//                  
//              2   127    1捆辣条(100根) 2捆辣条(1捆20根) 7根辣条:
//                      
